...
void ActorManager::RegisterGroup() {
	...
	AddGroup(ActorGroup::Block, "BlockRoot");
	AddGroup(ActorGroup::Enemy, "EnemyRoot");
	AddGroup(ActorGroup::Player, "PlayerRoot");
	AddGroup(ActorGroup::Boomerang, "BoomerangRoot");
	AddGroup(ActorGroup::UI, "UIRoot");
}

void ActorManager::Collide() {
	actors[ActorGroup::Player]->CollideChildren(*actors[ActorGroup::Enemy]);
	actors[ActorGroup::Boomerang]->CollideChildren(*actors[ActorGroup::Enemy]);
	actors[ActorGroup::Boomerang]->CollideChildren(*actors[ActorGroup::Block]);
}